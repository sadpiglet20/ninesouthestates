...
if (!function_exists('imic_enqueue_styles')) {
	function imic_enqueue_styles() {
		...
		wp_register_style('imic_owl_carousel', IMIC_THEME_PATH . '/plugins/owl-carousel/css/owl.carousel.css', array(), NULL, 'all');
		wp_register_style('imic_owl_theme', IMIC_THEME_PATH . '/plugins/owl-carousel/css/owl.theme.css', array(), NULL, 'all');
		...
		wp_enqueue_style('imic_style_rtl');
...
if (!function_exists('imic_enqueue_scripts')) {
    function imic_enqueue_scripts() {
		...
		wp_register_script('imic_jquery_owl_carousel', IMIC_THEME_PATH . '/plugins/owl-carousel/js/owl.carousel.min.js', array(), '', true);
		...
		wp_register_script('imic_profile_validate', IMIC_THEME_PATH . '/js/profile_validate.js', array(), '', true);
		...
		wp_localize_script('imic_jquery_init', 'urlajax', array('tmpurl' => get_template_directory_uri(),'is_property'=>is_singular('property'),'sticky'=>$sticky_menu,'is_contact'=>is_page_template('template-contact.php'),'home_url'=>  site_url(),'is_register'=>is_page_template('template-register.php'),'is_login'=>is_user_logged_in(),'is_submit_property'=>is_page_template('template-submit-property.php')));
