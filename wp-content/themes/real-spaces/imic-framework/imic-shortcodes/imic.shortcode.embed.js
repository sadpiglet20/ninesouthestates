function embedSelectedShortcode() {
	...
	if (current_shortcode != -1) {
		...
		/////////////////////////////////////////
		//Agents
		var agent_count = document.getElementById('agent-number').value;
		...
		var icon_start = document.getElementById('icon-start').value;
		var icon_end = document.getElementById('icon-end').value;
		...
		/////////////////////////////////////////
		if (shortcode_select == 'shortcode-agents') {
			shortcodeHTML = '<br/>[agents number="'+agent_count+'"]<br/>';	
		}
		...
		if (shortcode_select == 'shortcode-icons-box') {
			shortcodeHTML = '[icon_box start="'+icon_start+'" icon_image="'+icon_box_image+'" title="'+icon_title+'" description="'+icon_description+'" end="'+icon_end+'"]';	
		}
