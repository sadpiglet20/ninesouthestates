                        ...
                        <table class="table table-striped">
                            ...
                            <?php 
                                ...
                                <tr>
                                    ...
                                    <td><a href="<?php the_permalink(); ?>"><?php echo get_the_title(); ?></a><span class="pid"> (<?php echo $property_id; ?>)</span></td>
                                    ...
                                    <td>
                                        <a href="<?php echo add_query_arg( 'site', get_the_ID(), $edit_url ); ?>" class="action-button"><i class="fa fa-pencil"></i> <span><?php _e('Edit','framework'); ?></span></a>
                                        <a href="<?php the_permalink(); ?>" class="action-button"><i class="fa fa-eye"></i> <span><?php _e('View','framework'); ?></span></a>
                                        <a href="<?php echo add_query_arg( 'remove', get_the_ID() ); ?>" class="action-button"><i class="fa fa-ban"></i> <span><?php _e('Remove','framework'); ?></span></a>
                                    </td>
                                </tr>
                                <?php endwhile; ?>
                            </tbody>
