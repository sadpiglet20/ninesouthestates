...
?>
    ...
    <!-- End Showcase --> 
    <!-- Start Content -->
            <?php echo '<div class="main" role="main">
    <div id="content" class="content full">';
	  ...
	  if($Recent_List==1) { 
                    ...
                    echo'<div class="col-md-12"><div class="block-heading">';
			  ...
			  if(have_posts()):
                              ...
                              echo ' <li class="col-md-4 col-sm-6 type-rent"><div class="property-block">';
                          ...
                          echo '</div></li>';
                          endwhile; echo '</ul>'; endif; wp_reset_query(); 
                         echo '</div></div> </div>';
                         } $Featured_List = get_post_meta(get_the_ID(),'imic_home_featured_section',true); 
                         if($Featured_List==1) { 
                         echo '<div id="featured-properties">
                          <div class="container"><div class="row"> <div class="col-md-12"><div class="block-heading">';
                    $imic_home_recent_heading=get_post_meta(get_the_ID(),'imic_home_featured_heading',true);
                    $imic_home_recent_heading=!empty($imic_home_recent_heading)?$imic_home_recent_heading:__('Featured Properties','framework');
                    echo '<h4><span class="heading-icon"><i class="fa fa-leaf"></i></span>'.$imic_home_recent_heading.'</h4>';
                     $imic_home_recent_more=get_post_meta(get_the_ID(),'imic_home_recent_more',true);
                     if(!empty($imic_home_recent_more)){
                   echo '<a href="'.$imic_home_recent_more.'" class="btn btn-primary btn-sm pull-right">'.__('View more properties ','framework').'<i class="fa fa-long-arrow-right"></i></a>';   
                     ...
                     if(has_post_thumbnail()):
                          ...
                          echo '</div>';
                            ...
                            echo '<div class="padding-tb45 bottom-blocks">
                            <div class="container">
                            <div class="row">';
                            the_content();
                           echo '</div></div></div>';
                          endwhile; endif; 
                        $Partner_Heading = get_post_meta(get_the_ID(),'imic_home_partner_heading',true); 
                        $Partner_Heading_Url = get_post_meta(get_the_ID(),'imic_home_partner_url',true);
                        $Partner_Section = get_post_meta(get_the_ID(),'imic_home_partners_section',true);
