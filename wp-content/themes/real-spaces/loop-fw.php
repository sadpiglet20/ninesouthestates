...
$description = get_the_author_meta( 'description', $author_id ); if($userImage!='') { ?>
...
<div class="widget">
<h3 class="widgettitle"><?php _e('Additional Amenities','framework'); ?></h3>
<div id="amenities">
...
<div class="widget">
<h3 class="widgettitle"><?php _e('Property Details','framework'); ?></h3>
