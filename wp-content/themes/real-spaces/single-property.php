...
$output.= '<a href="#" class="accent-color" style="cursor:default; text-decoration:none;" data-toggle="tooltip" data-original-title="'.__('In your favorites','framework').'"><i class="fa fa-heart"></i></a>';
$output.='</div>';
return $output; }
else{
	 $output='<div class ="favorite_information">';
$output.= '<span class ="favorite"><a href="#" class="accent-color" style="text-decoration:none;" data-toggle="tooltip" data-original-title="'.__('Add this property to your favorites','framework').'"><i class="fa fa-heart-o"></i></a></span>';
        ...
        <div class="row">
          <div class="col-md-<?php echo $class; ?>">
			...
			$property_area = get_post_meta(get_the_ID(),'imic_property_area',true); 
              ...
              <h2 class="page-title"><?php echo get_the_title(); ?>, <span class="location"><?php echo $property_city; ?></span></h2>
              <div class="price"><strong><?php echo $currency_symbol; ?></strong><span><?php echo $property_price; ?></span></div>
              <div class="property-amenities clearfix"> <span class="area"><strong><?php _e('For','framework'); ?></strong><?php echo $property_term_type; ?></span> <span class="area"><strong><?php echo $property_area; ?></strong><?php _e('Area','framework'); ?></span> <span class="baths"><strong><?php echo $property_baths; ?></strong><?php _e('Baths','framework'); ?></span> <span class="beds"><strong><?php echo $property_beds; ?></strong><?php _e('Beds','framework'); ?></span> <span class="parking"><strong><?php echo $property_parking; ?></strong><?php _e('Parking','framework'); ?></span>  <span class="parking"><?php if ( is_plugin_active( 'favorite_property/favorite_property.php' ) ) { if(is_user_logged_in()) { $current_user = wp_get_current_user();
    	 echo imic_match_favourite_property($current_user->ID, get_the_ID()); } else {
...
'; } } ?></span></div>
              ...
              <div class="tabs">
                <ul class="nav nav-tabs">
                  <li class="active"> <a data-toggle="tab" href="#description"><?php _e(' Description ','framework'); ?></a> </li>
                  <li> <a data-toggle="tab" href="#amenities"><?php _e(' Additional Amenities ','framework'); ?></a> </li>
                  <li> <a data-toggle="tab" href="#address"><?php _e(' Property Details ','framework'); ?></a> </li>
                </ul>
                <div class="tab-content">
                  ...
                  <div id="amenities" class="tab-pane">
                        ...
                        <?php $property_amenities = get_post_meta(get_the_ID(),'imic_property_amenities',true);
						$amenity = array("Air Conditioning","Heating","Balcony","Dishwasher","Pool","Internet","Terrace","Microwave","Fridge","Cable TV","Security Camera","Toaster","Grill","Oven","Fans","Servants","Furnished","Cupboards"); 
						$count = 0;
						foreach($property_amenities as $property_amenitie) {
							if($property_amenitie!='Not Selected') { $class = 'available'; } else { $class = 'navailable'; } ?>
                    		<span class="<?php echo $class; ?>"><i class="fa fa-check-square"></i> <?php echo $amenity[$count]; ?></span>
                      <?php $count++; } ?>
                     	</div>
                  </div>
              		...
              		<div class="row">
                        ...
                        <?php $agent_image = get_the_author_meta('agent-image', $author_id);
						  ...
						  $description = get_the_author_meta( 'description', $author_id );?>
                        	<img src="<?php echo $userImage[0]; ?>">
                     	</div>
                    	<div class="col-md-8">
                      	<h4><a href="<?php echo get_author_posts_url($author_id); ?>"><?php echo $userName; ?></a></h4>
                         <?php echo apply_filters('the_content', $description); ?>
                          <div class="agent-contacts clearfix">
                          	<a href="<?php echo get_author_posts_url($author_id); ?>" class="btn btn-primary pull-right btn-sm"><?php _e('Agent Information','framework'); ?></a>&nbsp;<a data-target="#agentmodal" data-toggle="modal" class="btn btn-primary pull-right btn-sm"><?php _e('Contact Agent','framework'); ?></a>
            ...
            <h3><?php _e('Related Properties','framework'); ?></h3><hr>
            <div class="property-grid">
			  ...
			  $property_area = get_post_meta(get_the_ID(),'imic_property_area',true); 
                ...
                <li class="grid-item type-<?php echo $term->name; ?>">
                  <div class="property-block"> <a href="<?php the_permalink(); ?>" class="property-featured-image"> <?php the_post_thumbnail('600-400-size'); ?> <span class="images-count"><i class="fa fa-picture-o"></i> <?php echo $total_images; ?></span> <span class="badges"><?php echo $term->name; ?></span> </a>
