...
echo '<a id="drop1" href="#" role="button" class="dropdown-toggle" data-toggle="dropdown">Contract type <span class="caret"></span></a>';
...
$term_name = $term->name;
echo'<li><a role="presentation" role="menuitem" tabindex="-1" href="#filter-property-'.$term_name.'" data-filter-value=".'.$term_name.'" class="dropdown-toggle" data-toggle="dropdown">'.$term_name.'</a></li>';
}
echo'</ul></li>';
}
...
$term_name = $term->name;
echo'<li role="presentation"><a role="menuitem" tabindex="-1" href="#filter-property-'.$term_name.'" data-filter-value=".'.$term_name.'">'.$term_name.'</a></li>';
}
echo '</ul></li>';
}
?>
...
<ul class="nav navbar-nav navbar-right">
  <li id="fat-menu" class="dropdown">
    <a href="#" id="drop3" role="button" class="dropdown-toggle" data-toggle="dropdown"><?php _e('By custom','framework');?><span class="caret"></span></a>
...
<div class="agent-contact-form search_information">
                                      <h4><?php _e('Save this Search','framework'); ?></h4>
                                          ...
                                          <button type="button" class="btn btn-primary pull-right search"><?php _e('Submit','framework'); ?></button> </div>
