                          ...
                          <div class="row">
							  ...
							  if (!empty($userImageID)) {
								...
								echo '<div class="col-md-6 col-sm-6">
											<img src="'. $userImage[0].'" alt="'. $userName .'" class="img-thumbnail">
									  </div>';
								$userDescClass = 6;
							  }
							  ?>	
